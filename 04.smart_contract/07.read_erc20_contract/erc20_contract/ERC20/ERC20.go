...
//
// Solidity: function approve(address spender, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20Caller) Approve(opts *bind.CallOpts, spender common.Address, tokens *big.Int) (bool, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "approve", spender, tokens)
...
//
// Solidity: function approve(address spender, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20Session) Approve(spender common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.Approve(&_Erc20.CallOpts, spender, tokens)
}

// Approve is a free data retrieval call binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address spender, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20CallerSession) Approve(spender common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.Approve(&_Erc20.CallOpts, spender, tokens)
}
...
func (_Erc20 *Erc20Caller) Transfer(opts *bind.CallOpts, to common.Address, tokens *big.Int) (bool, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "transfer", to, tokens)
...
//
// Solidity: function transfer(address to, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20Session) Transfer(to common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.Transfer(&_Erc20.CallOpts, to, tokens)
}

// Transfer is a free data retrieval call binding the contract method 0xa9059cbb.
//
// Solidity: function transfer(address to, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20CallerSession) Transfer(to common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.Transfer(&_Erc20.CallOpts, to, tokens)
}

// TransferFrom is a free data retrieval call binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20Caller) TransferFrom(opts *bind.CallOpts, from common.Address, to common.Address, tokens *big.Int) (bool, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "transferFrom", from, to, tokens)
...
//
// Solidity: function transferFrom(address from, address to, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20Session) TransferFrom(from common.Address, to common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.TransferFrom(&_Erc20.CallOpts, from, to, tokens)
}

// TransferFrom is a free data retrieval call binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokens) view returns(bool success)
func (_Erc20 *Erc20CallerSession) TransferFrom(from common.Address, to common.Address, tokens *big.Int) (bool, error) {
	return _Erc20.Contract.TransferFrom(&_Erc20.CallOpts, from, to, tokens)
}
